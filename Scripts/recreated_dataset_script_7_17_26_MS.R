#Project: Recreating dataset averages (before adding wave exposure into dataset) from honors and analyses for Manuscript
#By: Maggie Schaffzin
...
#Re-creating a project directory
...
PISCO_final <- PISCO_final_merged %>%
  dplyr::rename(
    ...
    mean_gorgonian_density = mean_gorg_density,
