...
# Save CSV and RData
write_csv(all_results, "GLMM_scaled_results_all_species_7_16.csv")
save(model_results, file = "GLMM_scaled_species_models_7_16.RData")
...
write_csv(r2_summary_df, "GLMM_species_R2_summary_7_16.csv")
